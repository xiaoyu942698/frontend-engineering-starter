...
/**
 * Risk levels used by tool definitions and approval surfaces.
 */
export const riskLevelSchema = z.enum(['low', 'medium', 'high']);
export type RiskLevel = z.infer<typeof riskLevelSchema>;

/**
 * Agent capability metadata rendered by runtime catalogs and workflow editors.
 */
...
/**
 * Tool metadata shared by runtime adapters, risk prompts, and catalog UI.
 */
...
/**
 * Workflow graph node persisted by adapters and rendered by canvas components.
 */
...
/**
 * Complete workflow definition exchanged between builders, adapters, and mock API routes.
 */
...
/**
 * Runtime execution record used by lists, detail views, and approval callbacks.
 */
...
/**
 * Trace span shape reserved for adapters that expose observability timelines.
 */
...
/**
 * Human approval gate associated with a waiting runtime run.
 */
...
/**
 * Output artifact generated by a completed run.
 */
...
/**
 * Ordered runtime event streamed to audit, timeline, and debugging surfaces.
 */
...
/**
 * Read model that bootstraps the starter UI without binding it to one backend.
 */
